...
class Config:
    def __init__(self, file_path):
        ...
        # 执行文件内容，将变量导入到当前对象的命名空间
        exec(file_content, {}, self.__dict__)
...
def get_pretrained_language_model(text_encoder_type):
    if "bert-base-uncased" in text_encoder_type or (os.path.isdir(text_encoder_type) and os.path.exists(text_encoder_type)):
